...
const DEFAULT_CONSULTANTS = ["Elmarie", "Kristie", "Cindy", "Chelsea"] as const;
...
export default function NewSubmissionPage() {
  ...
  const [bondDueDate, setBondDueDate] = useState<string>("");
    ...
    async function loadConsultants() {
      try {
        ...
        if (list.length) {
          ...
          setConsultant((prev) => (prev && list.includes(prev) ? prev : list[0]));
        }
      } catch {}
    }
