    ...
    <div className="w-full">
      <div className="mx-auto max-w-7xl px-4 py-6 md:px-8 md:py-8 lg:px-10">
        ...
        <div className="mb-8 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <div className="text-[11px] font-bold uppercase tracking-[0.18em] text-[#142037]/55">Dashboard</div>
            <div className="mt-2 text-3xl font-bold tracking-[-0.03em] text-[#142037]">Executive Pipeline View</div>
          </div>
  ...
  <div className="rounded-2xl border border-black/10 bg-white p-6 shadow-sm">
    <div className="flex flex-wrap items-end justify-between gap-3">
      <div>
        ...
        <div className="mt-1 text-xs font-semibold text-black/60">
          We score each deal using 3 things: how far it has progressed, how big the deal value is, and how recent it is.
        </div>
        <div className="mt-1 text-xs font-semibold text-black/60">
          NTU deals reduce the score.
        </div>
      </div>
    </div>
