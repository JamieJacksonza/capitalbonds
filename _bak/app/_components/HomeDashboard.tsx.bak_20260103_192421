...
export default function HomeDashboard() {
  ...
  const donutSlices = useMemo(() => {
    ...
    return [...top, { label: "Other", key: "__other__", value: otherValue, color: "#9CA3AF" }];
  }, [grantedByConsultant]);
                  ...
                  <table className="w-full text-left text-xs">
                    <thead className="bg-black/5">
                      <tr>
                        ...
                        <th className="px-4 py-3 font-extrabold text-black">Granted Deals</th>
                        <th className="px-4 py-3 text-right font-extrabold text-black whitespace-nowrap tabular-nums">Granted Value</th>
                      </tr>
                    </thead>
                    <tbody>
                        ...
                        return (
                          <tr key={row.consultant} className="border-t border-black/10">
                            <td className="px-4 py-3 font-semibold text-black">
                              ...
                              <div className="mt-2 text-[11px] text-black/50">Share of total granted:{" "}
                                <span className="font-extrabold text-black">{pct.toFixed(1)}%</span>
                              </div>
                            </td>
                            <td className="px-4 py-3 align-top font-semibold text-black">{row.count}</td>
